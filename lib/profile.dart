      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              height: 80.0,
              margin: const EdgeInsetsDirectional.only(top: 294.2),
