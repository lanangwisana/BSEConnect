...
class SubstituteTeacher extends StatefulWidget {
  const SubstituteTeacher({super.key});

  @override
  State<SubstituteTeacher> createState() => _SubstituteTeacherState();
}

class _SubstituteTeacherState extends State<SubstituteTeacher> {
                      ...
                      children: <Widget>[
                        const Padding(
                          padding: EdgeInsetsDirectional.only(
                              top: 10.0), // Existing top padding
                        ),
                        // Add padding to ElevatedButton
                        Padding(
                  ...
                  Expanded(
                    child: IconButton(
                      icon: SvgPicture.string(
                        ...
                        semanticsLabel: "Sabstitute Teacher Icon",
                      ),
                      onPressed: () {},
                    ),
                  ),
